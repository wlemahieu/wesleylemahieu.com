        ...
        <div>
          <div className={`gradient-box-1`} style={{ padding: '2rem', margin: '3rem 0rem 0rem 1rem' }}>
            <p>
              ...
              test code with Jest, Chai, Sinon & React Testing Library. I'm currently in a waitlist for GPT-4 and am
              excited to learn and potentially integrate this into my workflow.
            </p>
          </div>
