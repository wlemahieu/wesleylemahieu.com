  ...
  return (
    <>
      ...
      <div className="content">
        <h2 className="content-subhead">Take control of your component renders!</h2>
        <sub>
          Feb 15th, 2023 - <i>By: Wesley LeMahieu</i>
        </sub>
        <div>
          <p>
            A common problem developers face in React.js is controlling when components re-render. It may go unnoticed
            at first, however, as your application grows in complexity, any extra renders will likely become more and
            more apparent. If you have a growing user-base, that will only exacerbate the problem. Extra component
            renders can be detrimental to the user experience of your application and also have the potential for
          ...
          <p>
            <b>Context</b> allows for parental component dissemination of state (and a state setter) to any amount of
            sub components that need a piece of state or the ability to mutate state.
          </p>
          ...
          <h4>How does it all make sense together?</h4>
          ...
          <h4>How do I test this out?</h4>

          <p>
            When you click <b>"Start"</b>, the demonstration will simulate an asynchronous API call using a hook which
            produces a changing loading state and finally a received payload of "accounts". Additionally, further
            renders can be tested by clicking the <b>"Add Acccount"</b> button. What you'll notice is the component
            subscribed to acccounts changing only renders when the <b>accounts</b> array changes, not when the{' '}
            <b>loading</b> state changes.
          </p>
          ...
          <p>
            ...
            responsibility is to render the total times the <b>Accounts</b> component renders using a crude state
            counter.
          </p>

          <h4>What's are the key takeaways?</h4>
